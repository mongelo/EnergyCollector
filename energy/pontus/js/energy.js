...
*/
		...
		var currency = [100000000,100000000,100000000,100000000,100000000,100000000,100000000,0,0,0];
        ...
        var anim = new Kinetic.Animation(function(frame) {
          pinkrect.setX(amplitude * Math.sin(frame.time * 2 * Math.PI / period - 200) );
		  pinkrect.setY(50*Math.sin(Math.sin(frame.time * 2 * Math.PI / period)) );
        }, pink);
        anim.start();
		...
		var anim2 = new Kinetic.Animation(function(frame) {
          blackrect.setX(amplitude * Math.sin((frame.time+200) * 2 * Math.PI / period - 200) );
		  blackrect.setY(50*Math.sin(Math.sin((frame.time+200) * 2 * Math.PI / period)) );
        }, black);
        anim2.start();
		...
		pink.on('mouseover touchmove', function() {
		...
		black.on('mouseover touchmove', function() {
